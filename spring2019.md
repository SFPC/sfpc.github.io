...
We will select up to 18 students for the session. Classes are usually held Monday-Friday between 10am and 1pm. Students are expected to participate full-time. There are student-led skill sharing sessions, lectures and workshops with visiting artists, field trips to institutions, schools, art spaces and dinners with special guests.
We offer an optional Onboarding week for students who are new to code or feel like they need additional time to focus on coding before the full session starts.
...
We are offering four days intensive for students who are new to coding or those who can use a refresher. We highly suggest the Onboarding Week for students who are not familiar with creative coding toolkit [openFrameworks](http://openframeworks.cc). From March 5th,to 8th, students will work with the core faculty to learn about the fundamental concepts and terms of computation, tools and environment for development. We recommend the Onboarding Week to beginners as well as students who are returning to coding after a long break. Tuition for Onboarding Week will be $500 for four days of classes, from 11am to 5pm. Check out our [blog posting](http://blog.sfpc.io/post/165343872176/fall-2017-coding-bootcamp) from 2017 Onboarding Week.    
...
Video from the first class in 2013 by Taeyoon Choi. 
...
$6000 USD for the 10 weeks program. We've charged $5500 for a few years. In 2019, we need to raise tuition by $500 because our rent is raising by 150% along with the costs of insurance and administration. We are also extending the program to five days per week. Onboarding week will be additional $500. SFPC is committed to provide quality learning experience to students and fair salaries to our teachers. SFPC does not make profit from 10 weeks program, as documented in our Finances Reports. 

When you are accepted to the program, you will recieve an invoice to make $2000 deposit by December 1st, 2018 and the remaining $4000 by February 1st, 2018. We accept tuition by check or wire transfer. 

If you are accepted but withdraw your participation by December 31st, 2018 we give a full return of deposit. If you cancel your participation after January 1st, 2018 we can't return your deposit. If you cancel your participation after February 1st, we can only return 50% of the full tuition. 
...
We are planning Fall 2019 session starting in April, 2019. We are also working on short Two-Weeks Intensive in Summer and Winter 2019. We also offer a variety of workshops and lectures. Please check our [blog](http://medium.com/sfpc) for the latest information.
